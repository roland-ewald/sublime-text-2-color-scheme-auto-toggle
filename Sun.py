...
2013-04-14 - Roland Ewald: taken from Henrik Härkönen's website (http://kortis.to/radix/),
http://kortis.to/radix/python/code/Sun.py, minor changes to docs
"""
...
class Sun:
  ...
  Usage:
  >>>  s = Sun()
  >>>  print s.get_max_solar_flux(46.2, 2004, 01, 30)
  >>>  print s.sunRiseSet(2002, 3, 22, 25.42, 62.15)
  """
  ...
  def __sunriset__(self, year, month, day, lon, lat, altit, upper_limb):
    ...
    Note: year,month,date = calendar date, 1801-2099 only.
        ...
        altit = the latitude which the Sun should cross
  ...
  def solar_altitude(self, latitude, year, month, day):
        ...
        true south.
        Declination is between 23.5 deg North and 23.5 deg South depending
